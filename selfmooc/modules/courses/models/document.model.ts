...
export async function createCourseDocumentDB(data: {
  ...
  try {
    const query = `
      INSERT INTO document (course_id, uploaded_by, title, description, doc_type, chapter, file_ext, file_size_kb, mongo_id) 
      VALUES ($1, $2, $3, $4, $5, $6, $7, $8, $9) 
      RETURNING document_id, title
    `;
    const values = [
      data.course_id, data.uploaded_by, data.title, data.description, 
